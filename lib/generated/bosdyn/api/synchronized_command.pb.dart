...
class SynchronizedCommand_Request extends $pb.GeneratedMessage {
  factory SynchronizedCommand_Request() => create();
...
class SynchronizedCommand_Feedback extends $pb.GeneratedMessage {
  factory SynchronizedCommand_Feedback() => create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SynchronizedCommand.Feedback', package: const $pb.PackageName(_omitMessageNames ? '' : 'bosdyn.api'), createEmptyInstance: create)
    ...
    ..aOM<$78.MobilityCommand_Feedback>(2, _omitFieldNames ? '' : 'mobilityCommandFeedback', subBuilder: $78.MobilityCommand_Feedback.create)
  ...
  @$pb.TagNumber(2)
  $78.MobilityCommand_Feedback get mobilityCommandFeedback => $_getN(1);
  @$pb.TagNumber(2)
  set mobilityCommandFeedback($78.MobilityCommand_Feedback v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMobilityCommandFeedback() => $_has(1);
  @$pb.TagNumber(2)
  void clearMobilityCommandFeedback() => clearField(2);
  @$pb.TagNumber(2)
  $78.MobilityCommand_Feedback ensureMobilityCommandFeedback() => $_ensure(1);
