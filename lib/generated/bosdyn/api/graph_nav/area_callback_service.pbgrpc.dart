...
class AreaCallbackServiceClient extends $grpc.Client {
  ...
  static final _$routeChange = $grpc.ClientMethod<$35.RouteChangeRequest, $35.RouteChangeResponse>(
      '/bosdyn.api.graph_nav.AreaCallbackService/RouteChange',
      ($35.RouteChangeRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $35.RouteChangeResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$35.RouteChangeResponse> routeChange($35.RouteChangeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$routeChange, request, options: options);
  }
...
abstract class AreaCallbackServiceBase extends $grpc.Service {
  ...
  AreaCallbackServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$35.RouteChangeRequest, $35.RouteChangeResponse>(
        'RouteChange',
        routeChange_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $35.RouteChangeRequest.fromBuffer(value),
        ($35.RouteChangeResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$35.RouteChangeResponse> routeChange_Pre($grpc.ServiceCall call, $async.Future<$35.RouteChangeRequest> request) async {
    return routeChange(call, await request);
  }
  ...
  $async.Future<$35.RouteChangeResponse> routeChange($grpc.ServiceCall call, $35.RouteChangeRequest request);
