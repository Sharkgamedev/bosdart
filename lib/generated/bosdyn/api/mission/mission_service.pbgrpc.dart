...
class MissionServiceClient extends $grpc.Client {
  ...
  static final _$loadMissionAsChunks = $grpc.ClientMethod<$4.DataChunk, $41.LoadMissionResponse>(
      '/bosdyn.api.mission.MissionService/LoadMissionAsChunks',
      ($4.DataChunk value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $41.LoadMissionResponse.fromBuffer(value));
  static final _$loadMissionAsChunks2 = $grpc.ClientMethod<$4.DataChunk, $4.DataChunk>(
  ...
  static final _$getInfoAsChunks = $grpc.ClientMethod<$41.GetInfoRequest, $4.DataChunk>(
  ...
  static final _$getMissionAsChunks = $grpc.ClientMethod<$41.GetMissionRequest, $4.DataChunk>(
  ...
  $grpc.ResponseFuture<$41.LoadMissionResponse> loadMissionAsChunks($async.Stream<$4.DataChunk> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$loadMissionAsChunks, request, options: options).single;
  }

  $grpc.ResponseStream<$4.DataChunk> loadMissionAsChunks2($async.Stream<$4.DataChunk> request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$4.DataChunk> getInfoAsChunks($41.GetInfoRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$4.DataChunk> getMissionAsChunks($41.GetMissionRequest request, {$grpc.CallOptions? options}) {
...
abstract class MissionServiceBase extends $grpc.Service {
  ...
  MissionServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$4.DataChunk, $41.LoadMissionResponse>(
        'LoadMissionAsChunks',
        loadMissionAsChunks,
        true,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$41.GetInfoRequest, $4.DataChunk>(
        'GetInfoAsChunks',
        getInfoAsChunks_Pre,
        false,
        true,
    ...
    $addMethod($grpc.ServiceMethod<$41.GetMissionRequest, $4.DataChunk>(
        'GetMissionAsChunks',
  ...
  $async.Stream<$4.DataChunk> getInfoAsChunks_Pre($grpc.ServiceCall call, $async.Future<$41.GetInfoRequest> request) async* {
  ...
  $async.Stream<$4.DataChunk> getMissionAsChunks_Pre($grpc.ServiceCall call, $async.Future<$41.GetMissionRequest> request) async* {
  ...
  $async.Future<$41.LoadMissionResponse> loadMissionAsChunks($grpc.ServiceCall call, $async.Stream<$4.DataChunk> request);
  $async.Stream<$4.DataChunk> loadMissionAsChunks2($grpc.ServiceCall call, $async.Stream<$4.DataChunk> request);
  ...
  $async.Stream<$4.DataChunk> getInfoAsChunks($grpc.ServiceCall call, $41.GetInfoRequest request);
  $async.Future<$41.GetMissionResponse> getMission($grpc.ServiceCall call, $41.GetMissionRequest request);
  $async.Stream<$4.DataChunk> getMissionAsChunks($grpc.ServiceCall call, $41.GetMissionRequest request);
