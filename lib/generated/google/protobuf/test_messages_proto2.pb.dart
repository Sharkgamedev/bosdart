...
class TestAllTypesProto2_NestedMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypesProto2.NestedMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'a', $pb.PbFieldType.O3)
    ..aOM<TestAllTypesProto2>(2, _omitFieldNames ? '' : 'corecursive', subBuilder: TestAllTypesProto2.create)
  ;
  ...
  'Will be removed in next major version')
  TestAllTypesProto2_NestedMessage copyWith(void Function(TestAllTypesProto2_NestedMessage) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_NestedMessage)) as TestAllTypesProto2_NestedMessage;
...
class TestAllTypesProto2_Data extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypesProto2.Data', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(202, _omitFieldNames ? '' : 'groupInt32', $pb.PbFieldType.O3)
    ..a<$core.int>(203, _omitFieldNames ? '' : 'groupUint32', $pb.PbFieldType.OU3)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllTypesProto2_Data copyWith(void Function(TestAllTypesProto2_Data) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_Data)) as TestAllTypesProto2_Data;
...
class TestAllTypesProto2_MessageSetCorrect extends $pb.$_MessageSet {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypesProto2.MessageSetCorrect', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..hasExtensions = true
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllTypesProto2_MessageSetCorrect copyWith(void Function(TestAllTypesProto2_MessageSetCorrect) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_MessageSetCorrect)) as TestAllTypesProto2_MessageSetCorrect;
...
class TestAllTypesProto2_MessageSetCorrectExtension1 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypesProto2.MessageSetCorrectExtension1', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..aOS(25, _omitFieldNames ? '' : 'str')
    ..hasRequiredFields = false
  ;
  static final messageSetExtension = $pb.Extension<TestAllTypesProto2_MessageSetCorrectExtension1>(_omitMessageNames ? '' : 'protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect', _omitFieldNames ? '' : 'messageSetExtension', 1547769, $pb.PbFieldType.OM, defaultOrMaker: TestAllTypesProto2_MessageSetCorrectExtension1.getDefault, subBuilder: TestAllTypesProto2_MessageSetCorrectExtension1.create);
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllTypesProto2_MessageSetCorrectExtension1 copyWith(void Function(TestAllTypesProto2_MessageSetCorrectExtension1) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_MessageSetCorrectExtension1)) as TestAllTypesProto2_MessageSetCorrectExtension1;
...
class TestAllTypesProto2_MessageSetCorrectExtension2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypesProto2.MessageSetCorrectExtension2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(9, _omitFieldNames ? '' : 'i', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  static final messageSetExtension = $pb.Extension<TestAllTypesProto2_MessageSetCorrectExtension2>(_omitMessageNames ? '' : 'protobuf_test_messages.proto2.TestAllTypesProto2.MessageSetCorrect', _omitFieldNames ? '' : 'messageSetExtension', 4135312, $pb.PbFieldType.OM, defaultOrMaker: TestAllTypesProto2_MessageSetCorrectExtension2.getDefault, subBuilder: TestAllTypesProto2_MessageSetCorrectExtension2.create);
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllTypesProto2_MessageSetCorrectExtension2 copyWith(void Function(TestAllTypesProto2_MessageSetCorrectExtension2) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2_MessageSetCorrectExtension2)) as TestAllTypesProto2_MessageSetCorrectExtension2;
...
class TestAllTypesProto2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypesProto2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ...
    ..aOM<TestAllTypesProto2_NestedMessage>(18, _omitFieldNames ? '' : 'optionalNestedMessage', subBuilder: TestAllTypesProto2_NestedMessage.create)
    ..aOM<ForeignMessageProto2>(19, _omitFieldNames ? '' : 'optionalForeignMessage', subBuilder: ForeignMessageProto2.create)
    ..e<TestAllTypesProto2_NestedEnum>(21, _omitFieldNames ? '' : 'optionalNestedEnum', $pb.PbFieldType.OE, defaultOrMaker: TestAllTypesProto2_NestedEnum.FOO, valueOf: TestAllTypesProto2_NestedEnum.valueOf, enumValues: TestAllTypesProto2_NestedEnum.values)
    ..e<ForeignEnumProto2>(22, _omitFieldNames ? '' : 'optionalForeignEnum', $pb.PbFieldType.OE, defaultOrMaker: ForeignEnumProto2.FOREIGN_FOO, valueOf: ForeignEnumProto2.valueOf, enumValues: ForeignEnumProto2.values)
    ..aOS(24, _omitFieldNames ? '' : 'optionalStringPiece')
    ..aOS(25, _omitFieldNames ? '' : 'optionalCord')
    ..aOM<TestAllTypesProto2>(27, _omitFieldNames ? '' : 'recursiveMessage', subBuilder: TestAllTypesProto2.create)
    ...
    ..pc<TestAllTypesProto2_NestedMessage>(48, _omitFieldNames ? '' : 'repeatedNestedMessage', $pb.PbFieldType.PM, subBuilder: TestAllTypesProto2_NestedMessage.create)
    ..pc<ForeignMessageProto2>(49, _omitFieldNames ? '' : 'repeatedForeignMessage', $pb.PbFieldType.PM, subBuilder: ForeignMessageProto2.create)
    ..pc<TestAllTypesProto2_NestedEnum>(51, _omitFieldNames ? '' : 'repeatedNestedEnum', $pb.PbFieldType.PE, valueOf: TestAllTypesProto2_NestedEnum.valueOf, enumValues: TestAllTypesProto2_NestedEnum.values, defaultEnumValue: TestAllTypesProto2_NestedEnum.FOO)
    ..pc<ForeignEnumProto2>(52, _omitFieldNames ? '' : 'repeatedForeignEnum', $pb.PbFieldType.PE, valueOf: ForeignEnumProto2.valueOf, enumValues: ForeignEnumProto2.values, defaultEnumValue: ForeignEnumProto2.FOREIGN_FOO)
    ..pPS(54, _omitFieldNames ? '' : 'repeatedStringPiece')
    ..pPS(55, _omitFieldNames ? '' : 'repeatedCord')
    ..m<$core.int, $core.int>(56, _omitFieldNames ? '' : 'mapInt32Int32', entryClassName: 'TestAllTypesProto2.MapInt32Int32Entry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.O3, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$fixnum.Int64, $fixnum.Int64>(57, _omitFieldNames ? '' : 'mapInt64Int64', entryClassName: 'TestAllTypesProto2.MapInt64Int64Entry', keyFieldType: $pb.PbFieldType.O6, valueFieldType: $pb.PbFieldType.O6, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.int, $core.int>(58, _omitFieldNames ? '' : 'mapUint32Uint32', entryClassName: 'TestAllTypesProto2.MapUint32Uint32Entry', keyFieldType: $pb.PbFieldType.OU3, valueFieldType: $pb.PbFieldType.OU3, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$fixnum.Int64, $fixnum.Int64>(59, _omitFieldNames ? '' : 'mapUint64Uint64', entryClassName: 'TestAllTypesProto2.MapUint64Uint64Entry', keyFieldType: $pb.PbFieldType.OU6, valueFieldType: $pb.PbFieldType.OU6, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.int, $core.int>(60, _omitFieldNames ? '' : 'mapSint32Sint32', entryClassName: 'TestAllTypesProto2.MapSint32Sint32Entry', keyFieldType: $pb.PbFieldType.OS3, valueFieldType: $pb.PbFieldType.OS3, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$fixnum.Int64, $fixnum.Int64>(61, _omitFieldNames ? '' : 'mapSint64Sint64', entryClassName: 'TestAllTypesProto2.MapSint64Sint64Entry', keyFieldType: $pb.PbFieldType.OS6, valueFieldType: $pb.PbFieldType.OS6, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.int, $core.int>(62, _omitFieldNames ? '' : 'mapFixed32Fixed32', entryClassName: 'TestAllTypesProto2.MapFixed32Fixed32Entry', keyFieldType: $pb.PbFieldType.OF3, valueFieldType: $pb.PbFieldType.OF3, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$fixnum.Int64, $fixnum.Int64>(63, _omitFieldNames ? '' : 'mapFixed64Fixed64', entryClassName: 'TestAllTypesProto2.MapFixed64Fixed64Entry', keyFieldType: $pb.PbFieldType.OF6, valueFieldType: $pb.PbFieldType.OF6, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.int, $core.int>(64, _omitFieldNames ? '' : 'mapSfixed32Sfixed32', entryClassName: 'TestAllTypesProto2.MapSfixed32Sfixed32Entry', keyFieldType: $pb.PbFieldType.OSF3, valueFieldType: $pb.PbFieldType.OSF3, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$fixnum.Int64, $fixnum.Int64>(65, _omitFieldNames ? '' : 'mapSfixed64Sfixed64', entryClassName: 'TestAllTypesProto2.MapSfixed64Sfixed64Entry', keyFieldType: $pb.PbFieldType.OSF6, valueFieldType: $pb.PbFieldType.OSF6, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.int, $core.double>(66, _omitFieldNames ? '' : 'mapInt32Float', entryClassName: 'TestAllTypesProto2.MapInt32FloatEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OF, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.int, $core.double>(67, _omitFieldNames ? '' : 'mapInt32Double', entryClassName: 'TestAllTypesProto2.MapInt32DoubleEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OD, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.bool, $core.bool>(68, _omitFieldNames ? '' : 'mapBoolBool', entryClassName: 'TestAllTypesProto2.MapBoolBoolEntry', keyFieldType: $pb.PbFieldType.OB, valueFieldType: $pb.PbFieldType.OB, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.String, $core.String>(69, _omitFieldNames ? '' : 'mapStringString', entryClassName: 'TestAllTypesProto2.MapStringStringEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.String, $core.List<$core.int>>(70, _omitFieldNames ? '' : 'mapStringBytes', entryClassName: 'TestAllTypesProto2.MapStringBytesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OY, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ...
    ..m<$core.String, TestAllTypesProto2_NestedEnum>(73, _omitFieldNames ? '' : 'mapStringNestedEnum', entryClassName: 'TestAllTypesProto2.MapStringNestedEnumEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OE, valueOf: TestAllTypesProto2_NestedEnum.valueOf, enumValues: TestAllTypesProto2_NestedEnum.values, valueDefaultOrMaker: TestAllTypesProto2_NestedEnum.FOO, defaultEnumValue: TestAllTypesProto2_NestedEnum.FOO, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..m<$core.String, ForeignEnumProto2>(74, _omitFieldNames ? '' : 'mapStringForeignEnum', entryClassName: 'TestAllTypesProto2.MapStringForeignEnumEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OE, valueOf: ForeignEnumProto2.valueOf, enumValues: ForeignEnumProto2.values, valueDefaultOrMaker: ForeignEnumProto2.FOREIGN_FOO, defaultEnumValue: ForeignEnumProto2.FOREIGN_FOO, packageName: const $pb.PackageName('protobuf_test_messages.proto2'))
    ..p<$core.int>(75, _omitFieldNames ? '' : 'packedInt32', $pb.PbFieldType.K3)
    ..p<$fixnum.Int64>(76, _omitFieldNames ? '' : 'packedInt64', $pb.PbFieldType.K6)
    ..p<$core.int>(77, _omitFieldNames ? '' : 'packedUint32', $pb.PbFieldType.KU3)
    ..p<$fixnum.Int64>(78, _omitFieldNames ? '' : 'packedUint64', $pb.PbFieldType.KU6)
    ..p<$core.int>(79, _omitFieldNames ? '' : 'packedSint32', $pb.PbFieldType.KS3)
    ..p<$fixnum.Int64>(80, _omitFieldNames ? '' : 'packedSint64', $pb.PbFieldType.KS6)
    ..p<$core.int>(81, _omitFieldNames ? '' : 'packedFixed32', $pb.PbFieldType.KF3)
    ..p<$fixnum.Int64>(82, _omitFieldNames ? '' : 'packedFixed64', $pb.PbFieldType.KF6)
    ..p<$core.int>(83, _omitFieldNames ? '' : 'packedSfixed32', $pb.PbFieldType.KSF3)
    ..p<$fixnum.Int64>(84, _omitFieldNames ? '' : 'packedSfixed64', $pb.PbFieldType.KSF6)
    ..p<$core.double>(85, _omitFieldNames ? '' : 'packedFloat', $pb.PbFieldType.KF)
    ..p<$core.double>(86, _omitFieldNames ? '' : 'packedDouble', $pb.PbFieldType.KD)
    ..p<$core.bool>(87, _omitFieldNames ? '' : 'packedBool', $pb.PbFieldType.KB)
    ..pc<TestAllTypesProto2_NestedEnum>(88, _omitFieldNames ? '' : 'packedNestedEnum', $pb.PbFieldType.KE, valueOf: TestAllTypesProto2_NestedEnum.valueOf, enumValues: TestAllTypesProto2_NestedEnum.values, defaultEnumValue: TestAllTypesProto2_NestedEnum.FOO)
    ..p<$core.int>(89, _omitFieldNames ? '' : 'unpackedInt32', $pb.PbFieldType.P3)
    ..p<$fixnum.Int64>(90, _omitFieldNames ? '' : 'unpackedInt64', $pb.PbFieldType.P6)
    ..p<$core.int>(91, _omitFieldNames ? '' : 'unpackedUint32', $pb.PbFieldType.PU3)
    ..p<$fixnum.Int64>(92, _omitFieldNames ? '' : 'unpackedUint64', $pb.PbFieldType.PU6)
    ..p<$core.int>(93, _omitFieldNames ? '' : 'unpackedSint32', $pb.PbFieldType.PS3)
    ..p<$fixnum.Int64>(94, _omitFieldNames ? '' : 'unpackedSint64', $pb.PbFieldType.PS6)
    ..p<$core.int>(95, _omitFieldNames ? '' : 'unpackedFixed32', $pb.PbFieldType.PF3)
    ..p<$fixnum.Int64>(96, _omitFieldNames ? '' : 'unpackedFixed64', $pb.PbFieldType.PF6)
    ..p<$core.int>(97, _omitFieldNames ? '' : 'unpackedSfixed32', $pb.PbFieldType.PSF3)
    ..p<$fixnum.Int64>(98, _omitFieldNames ? '' : 'unpackedSfixed64', $pb.PbFieldType.PSF6)
    ..p<$core.double>(99, _omitFieldNames ? '' : 'unpackedFloat', $pb.PbFieldType.PF)
    ..p<$core.double>(100, _omitFieldNames ? '' : 'unpackedDouble', $pb.PbFieldType.PD)
    ..p<$core.bool>(101, _omitFieldNames ? '' : 'unpackedBool', $pb.PbFieldType.PB)
    ..pc<TestAllTypesProto2_NestedEnum>(102, _omitFieldNames ? '' : 'unpackedNestedEnum', $pb.PbFieldType.PE, valueOf: TestAllTypesProto2_NestedEnum.valueOf, enumValues: TestAllTypesProto2_NestedEnum.values, defaultEnumValue: TestAllTypesProto2_NestedEnum.FOO)
    ..a<$core.int>(111, _omitFieldNames ? '' : 'oneofUint32', $pb.PbFieldType.OU3)
    ..aOM<TestAllTypesProto2_NestedMessage>(112, _omitFieldNames ? '' : 'oneofNestedMessage', subBuilder: TestAllTypesProto2_NestedMessage.create)
    ...
    ..a<$fixnum.Int64>(116, _omitFieldNames ? '' : 'oneofUint64', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..e<TestAllTypesProto2_NestedEnum>(119, _omitFieldNames ? '' : 'oneofEnum', $pb.PbFieldType.OE, defaultOrMaker: TestAllTypesProto2_NestedEnum.FOO, valueOf: TestAllTypesProto2_NestedEnum.valueOf, enumValues: TestAllTypesProto2_NestedEnum.values)
    ..a<TestAllTypesProto2_Data>(201, _omitFieldNames ? '' : 'data', $pb.PbFieldType.OG, subBuilder: TestAllTypesProto2_Data.create, defaultOrMaker: TestAllTypesProto2_Data.getDefault)
    ..a<$core.int>(241, _omitFieldNames ? '' : 'defaultInt32', $pb.PbFieldType.O3, defaultOrMaker: -123456789)
    ..a<$fixnum.Int64>(242, _omitFieldNames ? '' : 'defaultInt64', $pb.PbFieldType.O6, defaultOrMaker: $pb.parseLongInt('-9123456789123456789'))
    ..a<$core.int>(243, _omitFieldNames ? '' : 'defaultUint32', $pb.PbFieldType.OU3, defaultOrMaker: 2123456789)
    ..a<$fixnum.Int64>(244, _omitFieldNames ? '' : 'defaultUint64', $pb.PbFieldType.OU6, defaultOrMaker: $pb.parseLongInt('10123456789123456789'))
    ..a<$core.int>(245, _omitFieldNames ? '' : 'defaultSint32', $pb.PbFieldType.OS3, defaultOrMaker: -123456789)
    ..a<$fixnum.Int64>(246, _omitFieldNames ? '' : 'defaultSint64', $pb.PbFieldType.OS6, defaultOrMaker: $pb.parseLongInt('-9123456789123456789'))
    ..a<$core.int>(247, _omitFieldNames ? '' : 'defaultFixed32', $pb.PbFieldType.OF3, defaultOrMaker: 2123456789)
    ..a<$fixnum.Int64>(248, _omitFieldNames ? '' : 'defaultFixed64', $pb.PbFieldType.OF6, defaultOrMaker: $pb.parseLongInt('10123456789123456789'))
    ..a<$core.int>(249, _omitFieldNames ? '' : 'defaultSfixed32', $pb.PbFieldType.OSF3, defaultOrMaker: -123456789)
    ..a<$fixnum.Int64>(250, _omitFieldNames ? '' : 'defaultSfixed64', $pb.PbFieldType.OSF6, defaultOrMaker: $pb.parseLongInt('-9123456789123456789'))
    ..a<$core.double>(251, _omitFieldNames ? '' : 'defaultFloat', $pb.PbFieldType.OF, defaultOrMaker: 9e+09)
    ..a<$core.double>(252, _omitFieldNames ? '' : 'defaultDouble', $pb.PbFieldType.OD, defaultOrMaker: 7e+22)
    ..a<$core.bool>(253, _omitFieldNames ? '' : 'defaultBool', $pb.PbFieldType.OB, defaultOrMaker: true)
    ..a<$core.String>(254, _omitFieldNames ? '' : 'defaultString', $pb.PbFieldType.OS, defaultOrMaker: 'Rosebud')
    ..a<$core.List<$core.int>>(255, _omitFieldNames ? '' : 'defaultBytes', $pb.PbFieldType.OY, defaultOrMaker: () => <$core.int>[0x6a,0x6f,0x73,0x68,0x75,0x61])
    ...
    ..a<$core.int>(404, _omitFieldNames ? '' : 'fieldName4', $pb.PbFieldType.O3, protoName: 'field__name4_')
    ..a<$core.int>(405, _omitFieldNames ? '' : 'field0name5', $pb.PbFieldType.O3)
    ..a<$core.int>(406, _omitFieldNames ? '' : 'field0Name6', $pb.PbFieldType.O3, protoName: 'field_0_name6')
    ..a<$core.int>(407, _omitFieldNames ? '' : 'fieldName7', $pb.PbFieldType.O3, protoName: 'fieldName7')
    ..a<$core.int>(408, _omitFieldNames ? '' : 'FieldName8', $pb.PbFieldType.O3, protoName: 'FieldName8')
    ..a<$core.int>(409, _omitFieldNames ? '' : 'fieldName9', $pb.PbFieldType.O3, protoName: 'field_Name9')
    ..a<$core.int>(410, _omitFieldNames ? '' : 'FieldName10', $pb.PbFieldType.O3, protoName: 'Field_Name10')
    ..a<$core.int>(411, _omitFieldNames ? '' : 'FIELDNAME11', $pb.PbFieldType.O3, protoName: 'FIELD_NAME11')
    ..a<$core.int>(412, _omitFieldNames ? '' : 'FIELDName12', $pb.PbFieldType.O3, protoName: 'FIELD_name12')
    ..a<$core.int>(413, _omitFieldNames ? '' : 'FieldName13', $pb.PbFieldType.O3, protoName: '__field_name13')
    ..a<$core.int>(414, _omitFieldNames ? '' : 'FieldName14', $pb.PbFieldType.O3, protoName: '__Field_name14')
    ..a<$core.int>(415, _omitFieldNames ? '' : 'fieldName15', $pb.PbFieldType.O3, protoName: 'field__name15')
    ..a<$core.int>(416, _omitFieldNames ? '' : 'fieldName16', $pb.PbFieldType.O3, protoName: 'field__Name16')
    ..a<$core.int>(417, _omitFieldNames ? '' : 'fieldName17', $pb.PbFieldType.O3, protoName: 'field_name17__')
    ..a<$core.int>(418, _omitFieldNames ? '' : 'FieldName18', $pb.PbFieldType.O3, protoName: 'Field_name18__')
    ..hasExtensions = true
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllTypesProto2 copyWith(void Function(TestAllTypesProto2) updates) => super.copyWith((message) => updates(message as TestAllTypesProto2)) as TestAllTypesProto2;
...
class ForeignMessageProto2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ForeignMessageProto2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ForeignMessageProto2 copyWith(void Function(ForeignMessageProto2) updates) => super.copyWith((message) => updates(message as ForeignMessageProto2)) as ForeignMessageProto2;
...
class UnknownToTestAllTypes_OptionalGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnknownToTestAllTypes.OptionalGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'a', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnknownToTestAllTypes_OptionalGroup copyWith(void Function(UnknownToTestAllTypes_OptionalGroup) updates) => super.copyWith((message) => updates(message as UnknownToTestAllTypes_OptionalGroup)) as UnknownToTestAllTypes_OptionalGroup;
...
class UnknownToTestAllTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnknownToTestAllTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(1001, _omitFieldNames ? '' : 'optionalInt32', $pb.PbFieldType.O3)
    ..aOS(1002, _omitFieldNames ? '' : 'optionalString')
    ..aOM<ForeignMessageProto2>(1003, _omitFieldNames ? '' : 'nestedMessage', subBuilder: ForeignMessageProto2.create)
    ..a<UnknownToTestAllTypes_OptionalGroup>(1004, _omitFieldNames ? '' : 'optionalgroup', $pb.PbFieldType.OG, subBuilder: UnknownToTestAllTypes_OptionalGroup.create, defaultOrMaker: UnknownToTestAllTypes_OptionalGroup.getDefault)
    ..aOB(1006, _omitFieldNames ? '' : 'optionalBool')
    ..p<$core.int>(1011, _omitFieldNames ? '' : 'repeatedInt32', $pb.PbFieldType.P3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnknownToTestAllTypes copyWith(void Function(UnknownToTestAllTypes) updates) => super.copyWith((message) => updates(message as UnknownToTestAllTypes)) as UnknownToTestAllTypes;
...
class NullHypothesisProto2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NullHypothesisProto2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NullHypothesisProto2 copyWith(void Function(NullHypothesisProto2) updates) => super.copyWith((message) => updates(message as NullHypothesisProto2)) as NullHypothesisProto2;
...
class EnumOnlyProto2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnumOnlyProto2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EnumOnlyProto2 copyWith(void Function(EnumOnlyProto2) updates) => super.copyWith((message) => updates(message as EnumOnlyProto2)) as EnumOnlyProto2;
...
class OneStringProto2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OneStringProto2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OneStringProto2 copyWith(void Function(OneStringProto2) updates) => super.copyWith((message) => updates(message as OneStringProto2)) as OneStringProto2;
...
class ProtoWithKeywords extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProtoWithKeywords', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProtoWithKeywords copyWith(void Function(ProtoWithKeywords) updates) => super.copyWith((message) => updates(message as ProtoWithKeywords)) as ProtoWithKeywords;
  ...
  static $pb.PbList<ProtoWithKeywords> createRepeated() => $pb.PbList<ProtoWithKeywords>();
  @$core.pragma('dart2js:noInline')
  static ProtoWithKeywords getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ProtoWithKeywords>(create);
  static ProtoWithKeywords? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get inline => $_getIZ(0);
  @$pb.TagNumber(1)
  set inline($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set concept($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
...
class TestAllRequiredTypesProto2_NestedMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllRequiredTypesProto2.NestedMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'a', $pb.PbFieldType.Q3)
    ..aQM<TestAllRequiredTypesProto2>(2, _omitFieldNames ? '' : 'corecursive', subBuilder: TestAllRequiredTypesProto2.create)
    ..aOM<TestAllRequiredTypesProto2>(3, _omitFieldNames ? '' : 'optionalCorecursive', subBuilder: TestAllRequiredTypesProto2.create)
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_NestedMessage clone() => TestAllRequiredTypesProto2_NestedMessage()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_NestedMessage copyWith(void Function(TestAllRequiredTypesProto2_NestedMessage) updates) => super.copyWith((message) => updates(message as TestAllRequiredTypesProto2_NestedMessage)) as TestAllRequiredTypesProto2_NestedMessage;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_NestedMessage create() => TestAllRequiredTypesProto2_NestedMessage._();
  TestAllRequiredTypesProto2_NestedMessage createEmptyInstance() => create();
  static $pb.PbList<TestAllRequiredTypesProto2_NestedMessage> createRepeated() => $pb.PbList<TestAllRequiredTypesProto2_NestedMessage>();
  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_NestedMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TestAllRequiredTypesProto2_NestedMessage>(create);
  ...
  @$pb.TagNumber(2)
  set corecursive(TestAllRequiredTypesProto2 v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCorecursive() => $_has(1);
  @$pb.TagNumber(2)
  void clearCorecursive() => clearField(2);
  ...
  @$pb.TagNumber(3)
  set optionalCorecursive(TestAllRequiredTypesProto2 v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class TestAllRequiredTypesProto2_Data extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllRequiredTypesProto2.Data', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(202, _omitFieldNames ? '' : 'groupInt32', $pb.PbFieldType.Q3)
    ..a<$core.int>(203, _omitFieldNames ? '' : 'groupUint32', $pb.PbFieldType.QU3)
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_Data clone() => TestAllRequiredTypesProto2_Data()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_Data copyWith(void Function(TestAllRequiredTypesProto2_Data) updates) => super.copyWith((message) => updates(message as TestAllRequiredTypesProto2_Data)) as TestAllRequiredTypesProto2_Data;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_Data create() => TestAllRequiredTypesProto2_Data._();
  TestAllRequiredTypesProto2_Data createEmptyInstance() => create();
  static $pb.PbList<TestAllRequiredTypesProto2_Data> createRepeated() => $pb.PbList<TestAllRequiredTypesProto2_Data>();
  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_Data getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TestAllRequiredTypesProto2_Data>(create);
...
class TestAllRequiredTypesProto2_MessageSetCorrect extends $pb.$_MessageSet {
  ...
  factory TestAllRequiredTypesProto2_MessageSetCorrect.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllRequiredTypesProto2.MessageSetCorrect', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..hasExtensions = true
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_MessageSetCorrect clone() => TestAllRequiredTypesProto2_MessageSetCorrect()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_MessageSetCorrect copyWith(void Function(TestAllRequiredTypesProto2_MessageSetCorrect) updates) => super.copyWith((message) => updates(message as TestAllRequiredTypesProto2_MessageSetCorrect)) as TestAllRequiredTypesProto2_MessageSetCorrect;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_MessageSetCorrect create() => TestAllRequiredTypesProto2_MessageSetCorrect._();
  TestAllRequiredTypesProto2_MessageSetCorrect createEmptyInstance() => create();
  static $pb.PbList<TestAllRequiredTypesProto2_MessageSetCorrect> createRepeated() => $pb.PbList<TestAllRequiredTypesProto2_MessageSetCorrect>();
  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_MessageSetCorrect getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TestAllRequiredTypesProto2_MessageSetCorrect>(create);
...
class TestAllRequiredTypesProto2_MessageSetCorrectExtension1 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllRequiredTypesProto2.MessageSetCorrectExtension1', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..aQS(25, _omitFieldNames ? '' : 'str')
  ;
  static final messageSetExtension = $pb.Extension<TestAllRequiredTypesProto2_MessageSetCorrectExtension1>(_omitMessageNames ? '' : 'protobuf_test_messages.proto2.TestAllRequiredTypesProto2.MessageSetCorrect', _omitFieldNames ? '' : 'messageSetExtension', 1547769, $pb.PbFieldType.OM, defaultOrMaker: TestAllRequiredTypesProto2_MessageSetCorrectExtension1.getDefault, subBuilder: TestAllRequiredTypesProto2_MessageSetCorrectExtension1.create);

  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_MessageSetCorrectExtension1 clone() => TestAllRequiredTypesProto2_MessageSetCorrectExtension1()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_MessageSetCorrectExtension1 copyWith(void Function(TestAllRequiredTypesProto2_MessageSetCorrectExtension1) updates) => super.copyWith((message) => updates(message as TestAllRequiredTypesProto2_MessageSetCorrectExtension1)) as TestAllRequiredTypesProto2_MessageSetCorrectExtension1;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_MessageSetCorrectExtension1 create() => TestAllRequiredTypesProto2_MessageSetCorrectExtension1._();
  TestAllRequiredTypesProto2_MessageSetCorrectExtension1 createEmptyInstance() => create();
  static $pb.PbList<TestAllRequiredTypesProto2_MessageSetCorrectExtension1> createRepeated() => $pb.PbList<TestAllRequiredTypesProto2_MessageSetCorrectExtension1>();
  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_MessageSetCorrectExtension1 getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TestAllRequiredTypesProto2_MessageSetCorrectExtension1>(create);
  static TestAllRequiredTypesProto2_MessageSetCorrectExtension1? _defaultInstance;
...
class TestAllRequiredTypesProto2_MessageSetCorrectExtension2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllRequiredTypesProto2.MessageSetCorrectExtension2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(9, _omitFieldNames ? '' : 'i', $pb.PbFieldType.Q3)
  ;
  static final messageSetExtension = $pb.Extension<TestAllRequiredTypesProto2_MessageSetCorrectExtension2>(_omitMessageNames ? '' : 'protobuf_test_messages.proto2.TestAllRequiredTypesProto2.MessageSetCorrect', _omitFieldNames ? '' : 'messageSetExtension', 4135312, $pb.PbFieldType.OM, defaultOrMaker: TestAllRequiredTypesProto2_MessageSetCorrectExtension2.getDefault, subBuilder: TestAllRequiredTypesProto2_MessageSetCorrectExtension2.create);

  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_MessageSetCorrectExtension2 clone() => TestAllRequiredTypesProto2_MessageSetCorrectExtension2()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2_MessageSetCorrectExtension2 copyWith(void Function(TestAllRequiredTypesProto2_MessageSetCorrectExtension2) updates) => super.copyWith((message) => updates(message as TestAllRequiredTypesProto2_MessageSetCorrectExtension2)) as TestAllRequiredTypesProto2_MessageSetCorrectExtension2;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_MessageSetCorrectExtension2 create() => TestAllRequiredTypesProto2_MessageSetCorrectExtension2._();
  TestAllRequiredTypesProto2_MessageSetCorrectExtension2 createEmptyInstance() => create();
  static $pb.PbList<TestAllRequiredTypesProto2_MessageSetCorrectExtension2> createRepeated() => $pb.PbList<TestAllRequiredTypesProto2_MessageSetCorrectExtension2>();
  @$core.pragma('dart2js:noInline')
  static TestAllRequiredTypesProto2_MessageSetCorrectExtension2 getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TestAllRequiredTypesProto2_MessageSetCorrectExtension2>(create);
  static TestAllRequiredTypesProto2_MessageSetCorrectExtension2? _defaultInstance;
...
class TestAllRequiredTypesProto2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllRequiredTypesProto2', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_test_messages.proto2'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'requiredInt32', $pb.PbFieldType.Q3)
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'requiredInt64', $pb.PbFieldType.Q6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'requiredUint32', $pb.PbFieldType.QU3)
    ..a<$fixnum.Int64>(4, _omitFieldNames ? '' : 'requiredUint64', $pb.PbFieldType.QU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'requiredSint32', $pb.PbFieldType.QS3)
    ..a<$fixnum.Int64>(6, _omitFieldNames ? '' : 'requiredSint64', $pb.PbFieldType.QS6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(7, _omitFieldNames ? '' : 'requiredFixed32', $pb.PbFieldType.QF3)
    ..a<$fixnum.Int64>(8, _omitFieldNames ? '' : 'requiredFixed64', $pb.PbFieldType.QF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(9, _omitFieldNames ? '' : 'requiredSfixed32', $pb.PbFieldType.QSF3)
    ..a<$fixnum.Int64>(10, _omitFieldNames ? '' : 'requiredSfixed64', $pb.PbFieldType.QSF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.double>(11, _omitFieldNames ? '' : 'requiredFloat', $pb.PbFieldType.QF)
    ..a<$core.double>(12, _omitFieldNames ? '' : 'requiredDouble', $pb.PbFieldType.QD)
    ..a<$core.bool>(13, _omitFieldNames ? '' : 'requiredBool', $pb.PbFieldType.QB)
    ..aQS(14, _omitFieldNames ? '' : 'requiredString')
    ..a<$core.List<$core.int>>(15, _omitFieldNames ? '' : 'requiredBytes', $pb.PbFieldType.QY)
    ..aQM<TestAllRequiredTypesProto2_NestedMessage>(18, _omitFieldNames ? '' : 'requiredNestedMessage', subBuilder: TestAllRequiredTypesProto2_NestedMessage.create)
    ..aQM<ForeignMessageProto2>(19, _omitFieldNames ? '' : 'requiredForeignMessage', subBuilder: ForeignMessageProto2.create)
    ..e<TestAllRequiredTypesProto2_NestedEnum>(21, _omitFieldNames ? '' : 'requiredNestedEnum', $pb.PbFieldType.QE, defaultOrMaker: TestAllRequiredTypesProto2_NestedEnum.FOO, valueOf: TestAllRequiredTypesProto2_NestedEnum.valueOf, enumValues: TestAllRequiredTypesProto2_NestedEnum.values)
    ..e<ForeignEnumProto2>(22, _omitFieldNames ? '' : 'requiredForeignEnum', $pb.PbFieldType.QE, defaultOrMaker: ForeignEnumProto2.FOREIGN_FOO, valueOf: ForeignEnumProto2.valueOf, enumValues: ForeignEnumProto2.values)
    ..aQS(24, _omitFieldNames ? '' : 'requiredStringPiece')
    ..aQS(25, _omitFieldNames ? '' : 'requiredCord')
    ..aQM<TestAllRequiredTypesProto2>(27, _omitFieldNames ? '' : 'recursiveMessage', subBuilder: TestAllRequiredTypesProto2.create)
    ..aOM<TestAllRequiredTypesProto2>(28, _omitFieldNames ? '' : 'optionalRecursiveMessage', subBuilder: TestAllRequiredTypesProto2.create)
    ..a<TestAllRequiredTypesProto2_Data>(201, _omitFieldNames ? '' : 'data', $pb.PbFieldType.QG, subBuilder: TestAllRequiredTypesProto2_Data.create, defaultOrMaker: TestAllRequiredTypesProto2_Data.getDefault)
    ..a<$core.int>(241, _omitFieldNames ? '' : 'defaultInt32', $pb.PbFieldType.Q3, defaultOrMaker: -123456789)
    ..a<$fixnum.Int64>(242, _omitFieldNames ? '' : 'defaultInt64', $pb.PbFieldType.Q6, defaultOrMaker: $pb.parseLongInt('-9123456789123456789'))
    ..a<$core.int>(243, _omitFieldNames ? '' : 'defaultUint32', $pb.PbFieldType.QU3, defaultOrMaker: 2123456789)
    ..a<$fixnum.Int64>(244, _omitFieldNames ? '' : 'defaultUint64', $pb.PbFieldType.QU6, defaultOrMaker: $pb.parseLongInt('10123456789123456789'))
    ..a<$core.int>(245, _omitFieldNames ? '' : 'defaultSint32', $pb.PbFieldType.QS3, defaultOrMaker: -123456789)
    ..a<$fixnum.Int64>(246, _omitFieldNames ? '' : 'defaultSint64', $pb.PbFieldType.QS6, defaultOrMaker: $pb.parseLongInt('-9123456789123456789'))
    ..a<$core.int>(247, _omitFieldNames ? '' : 'defaultFixed32', $pb.PbFieldType.QF3, defaultOrMaker: 2123456789)
    ..a<$fixnum.Int64>(248, _omitFieldNames ? '' : 'defaultFixed64', $pb.PbFieldType.QF6, defaultOrMaker: $pb.parseLongInt('10123456789123456789'))
    ..a<$core.int>(249, _omitFieldNames ? '' : 'defaultSfixed32', $pb.PbFieldType.QSF3, defaultOrMaker: -123456789)
    ..a<$fixnum.Int64>(250, _omitFieldNames ? '' : 'defaultSfixed64', $pb.PbFieldType.QSF6, defaultOrMaker: $pb.parseLongInt('-9123456789123456789'))
    ..a<$core.double>(251, _omitFieldNames ? '' : 'defaultFloat', $pb.PbFieldType.QF, defaultOrMaker: 9e+09)
    ..a<$core.double>(252, _omitFieldNames ? '' : 'defaultDouble', $pb.PbFieldType.QD, defaultOrMaker: 7e+22)
    ..a<$core.bool>(253, _omitFieldNames ? '' : 'defaultBool', $pb.PbFieldType.QB, defaultOrMaker: true)
    ..a<$core.String>(254, _omitFieldNames ? '' : 'defaultString', $pb.PbFieldType.QS, defaultOrMaker: 'Rosebud')
    ..a<$core.List<$core.int>>(255, _omitFieldNames ? '' : 'defaultBytes', $pb.PbFieldType.QY, defaultOrMaker: () => <$core.int>[0x6a,0x6f,0x73,0x68,0x75,0x61])
    ..hasExtensions = true
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2 clone() => TestAllRequiredTypesProto2()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAllRequiredTypesProto2 copyWith(void Function(TestAllRequiredTypesProto2) updates) => super.copyWith((message) => updates(message as TestAllRequiredTypesProto2)) as TestAllRequiredTypesProto2;
  ...
  static $pb.PbList<TestAllRequiredTypesProto2> createRepeated() => $pb.PbList<TestAllRequiredTypesProto2>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set requiredInt32($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set requiredInt64($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set requiredUint32($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set requiredUint64($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set requiredSint32($core.int v) { $_setSignedInt32(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set requiredSint64($fixnum.Int64 v) { $_setInt64(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set requiredFixed32($core.int v) { $_setUnsignedInt32(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set requiredFixed64($fixnum.Int64 v) { $_setInt64(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set requiredSfixed32($core.int v) { $_setSignedInt32(8, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set requiredSfixed64($fixnum.Int64 v) { $_setInt64(9, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set requiredFloat($core.double v) { $_setFloat(10, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set requiredDouble($core.double v) { $_setDouble(11, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set requiredBool($core.bool v) { $_setBool(12, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set requiredString($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set requiredBytes($core.List<$core.int> v) { $_setBytes(14, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(18)
  TestAllRequiredTypesProto2_NestedMessage get requiredNestedMessage => $_getN(15);
  @$pb.TagNumber(18)
  set requiredNestedMessage(TestAllRequiredTypesProto2_NestedMessage v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasRequiredNestedMessage() => $_has(15);
  @$pb.TagNumber(18)
  void clearRequiredNestedMessage() => clearField(18);
  @$pb.TagNumber(18)
  TestAllRequiredTypesProto2_NestedMessage ensureRequiredNestedMessage() => $_ensure(15);

  @$pb.TagNumber(19)
  ForeignMessageProto2 get requiredForeignMessage => $_getN(16);
  @$pb.TagNumber(19)
  set requiredForeignMessage(ForeignMessageProto2 v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(21)
  set requiredNestedEnum(TestAllRequiredTypesProto2_NestedEnum v) { setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set requiredForeignEnum(ForeignEnumProto2 v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(24)
  set requiredStringPiece($core.String v) { $_setString(19, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set requiredCord($core.String v) { $_setString(20, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(27)
  set recursiveMessage(TestAllRequiredTypesProto2 v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasRecursiveMessage() => $_has(21);
  @$pb.TagNumber(27)
  void clearRecursiveMessage() => clearField(27);
  ...
  @$pb.TagNumber(28)
  set optionalRecursiveMessage(TestAllRequiredTypesProto2 v) { setField(28, v); }
  @$pb.TagNumber(28)
  ...
  @$pb.TagNumber(201)
  set data(TestAllRequiredTypesProto2_Data v) { setField(201, v); }
  @$pb.TagNumber(201)
  ...
  @$pb.TagNumber(241)
  set defaultInt32($core.int v) { $_setSignedInt32(24, v); }
  @$pb.TagNumber(241)
  ...
  @$pb.TagNumber(242)
  set defaultInt64($fixnum.Int64 v) { $_setInt64(25, v); }
  @$pb.TagNumber(242)
  ...
  @$pb.TagNumber(243)
  set defaultUint32($core.int v) { $_setUnsignedInt32(26, v); }
  @$pb.TagNumber(243)
  ...
  @$pb.TagNumber(244)
  set defaultUint64($fixnum.Int64 v) { $_setInt64(27, v); }
  @$pb.TagNumber(244)
  ...
  @$pb.TagNumber(245)
  set defaultSint32($core.int v) { $_setSignedInt32(28, v); }
  @$pb.TagNumber(245)
  ...
  @$pb.TagNumber(246)
  set defaultSint64($fixnum.Int64 v) { $_setInt64(29, v); }
  @$pb.TagNumber(246)
  ...
  @$pb.TagNumber(247)
  set defaultFixed32($core.int v) { $_setUnsignedInt32(30, v); }
  @$pb.TagNumber(247)
  ...
  @$pb.TagNumber(248)
  set defaultFixed64($fixnum.Int64 v) { $_setInt64(31, v); }
  @$pb.TagNumber(248)
  ...
  @$pb.TagNumber(249)
  set defaultSfixed32($core.int v) { $_setSignedInt32(32, v); }
  @$pb.TagNumber(249)
  ...
  @$pb.TagNumber(250)
  set defaultSfixed64($fixnum.Int64 v) { $_setInt64(33, v); }
  @$pb.TagNumber(250)
  ...
  @$pb.TagNumber(251)
  set defaultFloat($core.double v) { $_setFloat(34, v); }
  @$pb.TagNumber(251)
  ...
  @$pb.TagNumber(252)
  set defaultDouble($core.double v) { $_setDouble(35, v); }
  @$pb.TagNumber(252)
  ...
  @$pb.TagNumber(253)
  set defaultBool($core.bool v) { $_setBool(36, v); }
  @$pb.TagNumber(253)
  ...
  @$pb.TagNumber(254)
  set defaultString($core.String v) { $_setString(37, v); }
  @$pb.TagNumber(254)
  ...
  @$pb.TagNumber(255)
  set defaultBytes($core.List<$core.int> v) { $_setBytes(38, v); }
  @$pb.TagNumber(255)
...
class Test_messages_proto2 {
  static final extensionInt32 = $pb.Extension<$core.int>(_omitMessageNames ? '' : 'protobuf_test_messages.proto2.TestAllTypesProto2', _omitFieldNames ? '' : 'extensionInt32', 120, $pb.PbFieldType.O3);
