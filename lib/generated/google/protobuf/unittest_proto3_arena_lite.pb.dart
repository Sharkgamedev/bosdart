...
class TestAllTypes_NestedMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypes.NestedMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
...
class TestAllTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAllTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(50)
  $core.List<$100.ImportMessage> get repeatedImportMessage => $_getList(41);
...
class TestPackedTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestPackedTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
...
class TestUnpackedTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestUnpackedTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
...
class NestedTestAllTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NestedTestAllTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
...
class ForeignMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ForeignMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
...
class TestEmptyMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestEmptyMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
