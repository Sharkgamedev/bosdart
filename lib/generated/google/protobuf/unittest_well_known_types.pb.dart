...
import 'api.pb.dart' as $102;
import 'duration.pb.dart' as $61;
import 'empty.pb.dart' as $103;
...
class TestWellKnownTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestWellKnownTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ...
    ..aOM<$102.Api>(2, _omitFieldNames ? '' : 'apiField', subBuilder: $102.Api.create)
    ..aOM<$61.Duration>(3, _omitFieldNames ? '' : 'durationField', subBuilder: $61.Duration.create)
    ..aOM<$103.Empty>(4, _omitFieldNames ? '' : 'emptyField', subBuilder: $103.Empty.create)
    ..aOM<$82.FieldMask>(5, _omitFieldNames ? '' : 'fieldMaskField', subBuilder: $82.FieldMask.create)
    ..aOM<$90.SourceContext>(6, _omitFieldNames ? '' : 'sourceContextField', subBuilder: $90.SourceContext.create)
    ...
    ..aOM<$91.Type>(9, _omitFieldNames ? '' : 'typeField', subBuilder: $91.Type.create)
  ...
  @$pb.TagNumber(2)
  $102.Api get apiField => $_getN(1);
  @$pb.TagNumber(2)
  set apiField($102.Api v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasApiField() => $_has(1);
  @$pb.TagNumber(2)
  void clearApiField() => clearField(2);
  @$pb.TagNumber(2)
  $102.Api ensureApiField() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $103.Empty get emptyField => $_getN(3);
  @$pb.TagNumber(4)
  set emptyField($103.Empty v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEmptyField() => $_has(3);
  @$pb.TagNumber(4)
  void clearEmptyField() => clearField(4);
  @$pb.TagNumber(4)
  $103.Empty ensureEmptyField() => $_ensure(3);

  @$pb.TagNumber(5)
  $82.FieldMask get fieldMaskField => $_getN(4);
  @$pb.TagNumber(5)
  set fieldMaskField($82.FieldMask v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFieldMaskField() => $_has(4);
  @$pb.TagNumber(5)
  void clearFieldMaskField() => clearField(5);
  @$pb.TagNumber(5)
  $82.FieldMask ensureFieldMaskField() => $_ensure(4);

  @$pb.TagNumber(6)
  $90.SourceContext get sourceContextField => $_getN(5);
  @$pb.TagNumber(6)
  set sourceContextField($90.SourceContext v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasSourceContextField() => $_has(5);
  @$pb.TagNumber(6)
  void clearSourceContextField() => clearField(6);
  @$pb.TagNumber(6)
  $90.SourceContext ensureSourceContextField() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $91.Type get typeField => $_getN(8);
  @$pb.TagNumber(9)
  set typeField($91.Type v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTypeField() => $_has(8);
  @$pb.TagNumber(9)
  void clearTypeField() => clearField(9);
  @$pb.TagNumber(9)
  $91.Type ensureTypeField() => $_ensure(8);
...
class RepeatedWellKnownTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RepeatedWellKnownTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ...
    ..pc<$102.Api>(2, _omitFieldNames ? '' : 'apiField', $pb.PbFieldType.PM, subBuilder: $102.Api.create)
    ..pc<$61.Duration>(3, _omitFieldNames ? '' : 'durationField', $pb.PbFieldType.PM, subBuilder: $61.Duration.create)
    ..pc<$103.Empty>(4, _omitFieldNames ? '' : 'emptyField', $pb.PbFieldType.PM, subBuilder: $103.Empty.create)
    ..pc<$82.FieldMask>(5, _omitFieldNames ? '' : 'fieldMaskField', $pb.PbFieldType.PM, subBuilder: $82.FieldMask.create)
    ..pc<$90.SourceContext>(6, _omitFieldNames ? '' : 'sourceContextField', $pb.PbFieldType.PM, subBuilder: $90.SourceContext.create)
    ...
    ..pc<$91.Type>(9, _omitFieldNames ? '' : 'typeField', $pb.PbFieldType.PM, subBuilder: $91.Type.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$102.Api> get apiField => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$61.Duration> get durationField => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<$103.Empty> get emptyField => $_getList(3);

  @$pb.TagNumber(5)
  $core.List<$82.FieldMask> get fieldMaskField => $_getList(4);

  @$pb.TagNumber(6)
  $core.List<$90.SourceContext> get sourceContextField => $_getList(5);
  ...
  @$pb.TagNumber(9)
  $core.List<$91.Type> get typeField => $_getList(8);
...
class MapWellKnownTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MapWellKnownTypes', package: const $pb.PackageName(_omitMessageNames ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ...
    ..m<$core.int, $102.Api>(2, _omitFieldNames ? '' : 'apiField', entryClassName: 'MapWellKnownTypes.ApiFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $102.Api.create, valueDefaultOrMaker: $102.Api.getDefault, packageName: const $pb.PackageName('protobuf_unittest'))
    ...
    ..m<$core.int, $103.Empty>(4, _omitFieldNames ? '' : 'emptyField', entryClassName: 'MapWellKnownTypes.EmptyFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $103.Empty.create, valueDefaultOrMaker: $103.Empty.getDefault, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $82.FieldMask>(5, _omitFieldNames ? '' : 'fieldMaskField', entryClassName: 'MapWellKnownTypes.FieldMaskFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $82.FieldMask.create, valueDefaultOrMaker: $82.FieldMask.getDefault, packageName: const $pb.PackageName('protobuf_unittest'))
    ..m<$core.int, $90.SourceContext>(6, _omitFieldNames ? '' : 'sourceContextField', entryClassName: 'MapWellKnownTypes.SourceContextFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $90.SourceContext.create, valueDefaultOrMaker: $90.SourceContext.getDefault, packageName: const $pb.PackageName('protobuf_unittest'))
    ...
    ..m<$core.int, $91.Type>(9, _omitFieldNames ? '' : 'typeField', entryClassName: 'MapWellKnownTypes.TypeFieldEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $91.Type.create, valueDefaultOrMaker: $91.Type.getDefault, packageName: const $pb.PackageName('protobuf_unittest'))
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.int, $102.Api> get apiField => $_getMap(1);

  @$pb.TagNumber(3)
  $core.Map<$core.int, $61.Duration> get durationField => $_getMap(2);

  @$pb.TagNumber(4)
  $core.Map<$core.int, $103.Empty> get emptyField => $_getMap(3);

  @$pb.TagNumber(5)
  $core.Map<$core.int, $82.FieldMask> get fieldMaskField => $_getMap(4);

  @$pb.TagNumber(6)
  $core.Map<$core.int, $90.SourceContext> get sourceContextField => $_getMap(5);
  ...
  @$pb.TagNumber(9)
  $core.Map<$core.int, $91.Type> get typeField => $_getMap(8);
