...
class Enum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Enum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..aOM<$95.SourceContext>(4, _omitFieldNames ? '' : 'sourceContext', subBuilder: $95.SourceContext.create)
  ...
  /// The source context.
  @$pb.TagNumber(4)
  $95.SourceContext get sourceContext => $_getN(3);
  @$pb.TagNumber(4)
  set sourceContext($95.SourceContext v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSourceContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearSourceContext() => clearField(4);
  @$pb.TagNumber(4)
  $95.SourceContext ensureSourceContext() => $_ensure(3);
