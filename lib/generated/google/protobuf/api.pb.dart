...
class Api extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Api', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$91.Option>(3, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $91.Option.create)
    ...
    ..e<$91.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $91.Syntax.SYNTAX_PROTO2, valueOf: $91.Syntax.valueOf, enumValues: $91.Syntax.values)
  ...
  @$pb.TagNumber(3)
  $core.List<$91.Option> get options => $_getList(2);
  ...
  @$pb.TagNumber(7)
  $91.Syntax get syntax => $_getN(6);
  @$pb.TagNumber(7)
  set syntax($91.Syntax v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class Method extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Method', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$91.Option>(6, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $91.Option.create)
    ..e<$91.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $91.Syntax.SYNTAX_PROTO2, valueOf: $91.Syntax.valueOf, enumValues: $91.Syntax.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.List<$91.Option> get options => $_getList(5);
