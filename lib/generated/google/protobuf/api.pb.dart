...
class Api extends $pb.GeneratedMessage {
  factory Api({
    ...
    $core.Iterable<$96.Option>? options,
    $core.String? version,
    $95.SourceContext? sourceContext,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Api', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$96.Option>(3, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $96.Option.create)
    ..aOS(4, _omitFieldNames ? '' : 'version')
    ..aOM<$95.SourceContext>(5, _omitFieldNames ? '' : 'sourceContext', subBuilder: $95.SourceContext.create)
    ..pc<Mixin>(6, _omitFieldNames ? '' : 'mixins', $pb.PbFieldType.PM, subBuilder: Mixin.create)
    ..e<$96.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $96.Syntax.SYNTAX_PROTO2, valueOf: $96.Syntax.valueOf, enumValues: $96.Syntax.values)
  ...
  @$pb.TagNumber(3)
  $core.List<$96.Option> get options => $_getList(2);
  ...
  /// message.
  @$pb.TagNumber(5)
  $95.SourceContext get sourceContext => $_getN(4);
  @$pb.TagNumber(5)
  set sourceContext($95.SourceContext v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceContext() => $_has(4);
  @$pb.TagNumber(5)
  void clearSourceContext() => clearField(5);
  @$pb.TagNumber(5)
  $95.SourceContext ensureSourceContext() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $96.Syntax get syntax => $_getN(6);
  @$pb.TagNumber(7)
  set syntax($96.Syntax v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class Method extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Method', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$96.Option>(6, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $96.Option.create)
    ..e<$96.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $96.Syntax.SYNTAX_PROTO2, valueOf: $96.Syntax.valueOf, enumValues: $96.Syntax.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.List<$96.Option> get options => $_getList(5);
