...
class MapEnum extends $pb.ProtobufEnum {
  static const MapEnum MAP_ENUM_FOO = MapEnum._(0, _omitEnumNames ? '' : 'MAP_ENUM_FOO');
  static const MapEnum MAP_ENUM_BAR = MapEnum._(1, _omitEnumNames ? '' : 'MAP_ENUM_BAR');
  static const MapEnum MAP_ENUM_BAZ = MapEnum._(2, _omitEnumNames ? '' : 'MAP_ENUM_BAZ');
...
class MessageContainingEnumCalledType_Type extends $pb.ProtobufEnum {
  static const MessageContainingEnumCalledType_Type TYPE_FOO = MessageContainingEnumCalledType_Type._(0, _omitEnumNames ? '' : 'TYPE_FOO');
